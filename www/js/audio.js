...
.controller('audioController', function($scope, $ionicLoading, $window, $timeout, $interval,
 $parse, options, enums, audioContext, soundtouch,$state) {
  ...
  angular.extend($scope, {
    ...
    readFile: function() {
      ...
      fileReader.onload = function(event) {
        ...
        console.log($state.params.videoURL);
        prepareTrack($state.params.videoURL);
      };
      $ionicLoading.show({
